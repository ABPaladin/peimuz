...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="relative" style={{ background: '#F5EDD6' }}>
      {/* Subtle line texture */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          backgroundImage:
            'repeating-linear-gradient(0deg, transparent, transparent 47px, rgba(201,168,76,0.06) 47px, rgba(201,168,76,0.06) 48px)',
        }}
      />
        ...
        >
          {galleryItems.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="reveal group relative cursor-pointer overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(74,44,10,0.15)]"
                style={{
              ...
              >
                ...
                >
                  {cover ? (
                    ...
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(135deg, var(--parchment) 0%, #ddd0b0 100%)',
                      }}
                    >
                      <span
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(to top, rgba(74,44,10,0.9) 0%, rgba(74,44,10,0.3) 60%, transparent 100%)',
                    }}
                  >
                    <div>
                      <div
                ...
                {/* Caption */}
                <div className="px-5 py-4" style={{ borderTop: '1px solid rgba(201,168,76,0.3)' }}>
                  <h4
