...
export default function Lightbox({ item, onClose }) {
  ...
  return (
    <div
      ...
      style={{ background: 'rgba(26,16,6,0.95)' }}
      ...
      >
        ...
        {item.link && (
          <a
            ...
            className="inline-block mt-5 px-5 py-[0.55rem] font-['Crimson_Text'] text-base tracking-wider transition-opacity duration-200 hover:opacity-90"
            style={{ background: 'var(--red)', color: 'var(--cream)' }}
          >
